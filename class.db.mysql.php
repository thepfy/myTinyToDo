...
/*
    Modified 6 Jan 2018 Q
    Updated to move database calls to MySQLi in place of deprecated mysql calls (PHP 7.X support)
*/
...
class Database_Mysql
{
	...
	{
		if(!$this->dbh = @($GLOBALS["___mysqli_ston"] = mysqli_connect($host, $user, $pass)))
		{
	...
	{
		return ((is_null($___mysqli_res = mysqli_insert_id($this->dbh))) ? false : $___mysqli_res);
	}	
